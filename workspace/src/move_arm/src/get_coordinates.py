...
def get_block_coordinates(side_length=.04, offset=0, origin=[0,-0.08,0], filename="/home/cc/ee106a/fa23/class/ee106a-agn/workspace/src/move_arm/src/model.json"):
    """
    ...
    for block in blocks:
        ...
        adjusted_y = origin[2] + block[1] * (side_length + offset)
        adjusted_z = origin[1] + block[2] * (side_length + offset)
